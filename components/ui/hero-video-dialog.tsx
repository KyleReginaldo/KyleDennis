...
interface HeroVideoProps {
  ...
  /** "center" is the original giant circular play button; "corner" is a small labeled pill in the bottom-right corner. */
  trigger?: "center" | "corner"
  triggerLabel?: string
}
...
export function HeroVideoDialog({
  ...
  return (
    <div className={cn("relative", className)}>
      <button
        type="button"
        aria-label={trigger === "corner" ? `Play ${triggerLabel.toLowerCase()}` : "Play video"}
      ...
      >
        ...
        {trigger === "center" ? (
          ...
          <div className="absolute right-4 bottom-4">
            <span className="inline-flex items-center gap-2 rounded-full bg-white px-4 py-2.5 text-sm font-semibold text-neutral-900 shadow-xl ring-2 ring-black/10 transition-transform group-hover:scale-105">
